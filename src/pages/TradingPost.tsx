  ...
  return (
    <div className="min-h-screen bg-parchment relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        {/* Large decorative compass rose - centered */}
        ...
        {/* Edge vignette - ink fade at edges */}
        ...
        <section className="py-24 relative z-10">
          <div className="text-center">
            ...
            <Button 
              ...
              variant="outline"
              className="border-tyrian/30 text-ink hover:bg-tyrian/10"
            >
              Try Again
            </Button>
          </div>
            ...
            {searchResults && searchResults.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <Button
                  variant="ghost"
                  onClick={() => setSearchQuery("")}
                  className="mt-4 text-tyrian hover:text-tyrian/80"
                >
                  Clear search
                </Button>
              </div>
        ...
        <section className="py-16 relative z-10">
          <div className="container mx-auto px-4">
            ...
            {allProducts.length > 0 ? (
              ...
              <div className="text-center py-16">
                <Package className="w-12 h-12 text-ink/30 mx-auto mb-4" />
                <p className="text-ink/60 font-heading">The cargo holds are currently empty</p>
              </div>
            )}
          </div>
        </section>
