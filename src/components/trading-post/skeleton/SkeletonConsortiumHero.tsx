  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2">
        ...
        {/* Content Side */}
        <div className="p-5 md:p-6 lg:p-8 flex flex-col justify-center min-h-0">
          ...
          <h2 className="font-blackpearl text-3xl md:text-4xl lg:text-5xl text-parchment mb-3">
            Cradle of Fire
          </h2>

          <p className="text-parchment/70 font-body leading-relaxed mb-3 italic text-sm md:text-base">
