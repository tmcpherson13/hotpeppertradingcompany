...
const pepperProfiles = [
  ...
  },
  {
    ...
    role: 'Body — bridging the Caribbean to the American South through Minorcan heritage.',
  },
  {
    name: 'Wiri Wiri',
    ...
    role: 'Vanguard — the secret weapon of Guyanese pepperpot and South American Caribbean kitchens.',
  },
  {
