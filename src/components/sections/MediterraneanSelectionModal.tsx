...
const pepperProfiles = [
  ...
  },
  {
    ...
    heat: 'Mild (1,000–4,000 SHU)',
    flavor: 'Sweet, slightly smoky with gentle warmth and complex fruity undertones.',
    role: 'Finisher — the refined French touch, adding depth without dominating.',
  },
];
...
const pairings = [
  ...
  'Espelette-dusted eggs or piperade',
            ...
            <div className="p-6 md:p-8 pb-16 space-y-8">
              ...
              <div className="flex items-center justify-center gap-8 py-4 border-t border-dashed border-ink/20">
                ...
                <div className="text-center">
                  ...
                  <span className="font-display text-ink">1,000–40,000 SHU</span>
                </div>
              </div>
            </div>
          </div>
