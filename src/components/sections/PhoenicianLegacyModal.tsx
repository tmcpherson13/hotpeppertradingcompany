...
const pepperProfiles = [
  {
    ...
    role: 'The Anchor—from one of the oldest continuously inhabited cities on the ancient trade routes, where caravans rested and cultures converged.',
  },
  {
    name: 'Calabrian',
    ...
    role: 'The Flame—brought by Spanish traders to the sun-drenched toe of Italy, where it became essential to Calabrian identity.',
  },
  {
    name: 'Urfa Biber',
    ...
    role: 'The Depths—cured in the ancient Anatolian sun, sweated overnight to develop its haunting complexity.',
  },
  {
    name: 'Peri Peri',
    ...
    role: 'The Voyage—Portuguese navigators carried peppers from the New World around the Cape, fusing Mediterranean and African traditions.',
  },
  {
    name: 'Fresno',
    ...
    role: 'The Legacy—Spanish missions carried Mediterranean pepper traditions to California, where the Fresno emerged as their modern heir.',
  },
];
            ...
            <div className="p-6 md:p-8 space-y-8">
              ...
              <section className="text-center py-4">
                ...
                <p className="mt-4 text-xs uppercase tracking-[0.2em] text-muted-foreground font-heading">
                  Consortium № 007 • Limited Production • Mediterranean Basin
                </p>
              </section>
