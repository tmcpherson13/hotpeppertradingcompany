...
const pepperProfiles = [
  ...
  },
  {
    ...
    role: 'Bridge — the soul of Peruvian cuisine.',
  },
  {
    name: 'Wiri Wiri',
    ...
    role: 'Body — Amazonian fire from the Guyanese frontier.',
  },
  {
    name: 'Aji Panca',
    ...
    role: 'Vanguard — sun-dried coastal pepper, the color of Peruvian cuisine.',
  },
  {
    name: 'Rocoto',
    ...
    role: 'Flagship — the only pepper that thrives in the cold.',
  },
];
