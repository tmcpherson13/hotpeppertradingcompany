...
export function SilkJadePassagesModal({ open, onOpenChange }: SilkJadePassagesModalProps) {
  console.log('[SilkJadePassagesModal] Rendering with open:', open);
        ...
        <ScrollArea className="h-[90vh] min-h-[200px]">
          <div className="relative">
            ...
            <div className="relative h-64 md:h-80 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <DialogHeader>
                  ...
                  <DialogDescription className="sr-only">Details about the Silk & Jade Passages pepper consortium</DialogDescription>
                </DialogHeader>
            ...
            <div className="p-6 md:p-8 pb-16 space-y-8">
              ...
              {/* Trade Details */}
              <ConsortiumTradeDetails consortiumId="silk-jade-passages" heatRange="4,000–1,041,427 SHU" />
