...
const pepperProfiles = [
  {
    ...
    role: 'Anchor — the dried poblano that Spanish galleons carried from Acapulco, the starting point of the trans-Pacific crossing.',
  },
  {
    name: 'Aji Amarillo',
    ...
    role: 'Bridge — Peru\'s most beloved pepper, carried by Spanish ships to Manila as part of the silver-for-silk exchange.',
  },
  {
    ...
    role: 'Body — Portuguese and Spanish traders introduced New World peppers to Southeast Asia, where they transformed local cuisines.',
  },
  {
    name: 'Gochugaru',
    ...
    role: 'Vanguard — arriving via both the sea routes through Manila and overland through China, Korean cuisine embraced the pepper completely.',
  },
  {
    name: 'Ghost Pepper',
    ...
    role: 'Flagship — Portuguese traders brought peppers to India, where they evolved into one of the world\'s most fearsome cultivars.',
  },
];
...
export function ManilaGalleonModal({ open, onOpenChange }: ManilaGalleonModalProps) {
  console.log('[ManilaGalleonModal] Rendering with open:', open);
        ...
        <ScrollArea className="max-h-[90vh] min-h-[200px]">
          <div className="relative">
            ...
            <div className="p-6 md:p-8 pb-16 space-y-8">
              ...
              {/* Trade Details */}
              <ConsortiumTradeDetails consortiumId="manila-galleon" heatRange="1,000–1,041,000 SHU" />
