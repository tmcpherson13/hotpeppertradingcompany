// Auto-generated pepper image imports
...
import bellPepperImg from '@/assets/peppers/bell-pepper.jpg';
import poblanoImg from '@/assets/peppers/poblano.jpg';
import jalapenoImg from '@/assets/peppers/jalapeno.jpg';
import serranoImg from '@/assets/peppers/serrano.jpg';
import cayenneImg from '@/assets/peppers/cayenne.jpg';
import hungarianWaxImg from '@/assets/peppers/hungarian-wax.jpg';
import bananaPepperImg from '@/assets/peppers/banana-pepper.jpg';
import shishitoImg from '@/assets/peppers/shishito.jpg';
import padronImg from '@/assets/peppers/padron.jpg';
import peppadewImg from '@/assets/peppers/peppadew.jpg';
import espeletteImg from '@/assets/peppers/espelette.jpg';
import urfaBiberImg from '@/assets/peppers/urfa-biber.jpg';
import kashmiriChiliImg from '@/assets/peppers/kashmiri-chili.jpg';
import gunturSannamImg from '@/assets/peppers/guntur-sannam.jpg';
import byadgiImg from '@/assets/peppers/byadgi.jpg';
import thaiBirdsEyeImg from '@/assets/peppers/thai-birds-eye.jpg';
import periPeriAfricanImg from '@/assets/peppers/peri-peri-african.jpg';
import tabascoImg from '@/assets/peppers/tabasco.jpg';
import habaneroImg from '@/assets/peppers/habanero.jpg';
import bhutJolokiaImg from '@/assets/peppers/bhut-jolokia.jpg';
import carolinaReaperImg from '@/assets/peppers/carolina-reaper.jpg';
...
import ajiCerezoImg from '@/assets/peppers/aji-cerezo.jpg';
import ajiDulceImg from '@/assets/peppers/aji-dulce.jpg';
import charapitaImg from '@/assets/peppers/charapita.jpg';
import biquinhoImg from '@/assets/peppers/biquinho.jpg';
import bahamianGoatImg from '@/assets/peppers/bahamian-goat.jpg';
import sevenPotDouglahImg from '@/assets/peppers/7-pot-douglah.jpg';
import sevenPotPrimoImg from '@/assets/peppers/7-pot-primo.jpg';
import manzanoImg from '@/assets/peppers/manzano.jpg';
import guindillaImg from '@/assets/peppers/guindilla.jpg';
import fresnoImg from '@/assets/peppers/fresno.jpg';
import cherryPepperImg from '@/assets/peppers/cherry-pepper.jpg';
import cubanelleImg from '@/assets/peppers/cubanelle.jpg';
import anaheimImg from '@/assets/peppers/anaheim.jpg';
import cascabelImg from '@/assets/peppers/cascabel.jpg';
import arbolImg from '@/assets/peppers/arbol.jpg';
import mulatoImg from '@/assets/peppers/mulato.jpg';
import mirasolImg from '@/assets/peppers/mirasol.jpg';
import tepinImg from '@/assets/peppers/tepin.jpg';
import tienTsinImg from '@/assets/peppers/tien-tsin.jpg';
import erJingTiaoImg from '@/assets/peppers/er-jing-tiao.jpg';
import facingHeavenImg from '@/assets/peppers/facing-heaven.jpg';
import koreanCheongyangImg from '@/assets/peppers/korean-cheongyang.jpg';
import silingLabuyoImg from '@/assets/peppers/siling-labuyo.jpg';
import birdsEyeMalaysiaImg from '@/assets/peppers/birds-eye-malaysia.jpg';
import madameJeanetteImg from '@/assets/peppers/madame-jeanette.jpg';
import adjumaImg from '@/assets/peppers/adjuma.jpg';
import congoPepperImg from '@/assets/peppers/congo-pepper.jpg';
import rocotilloImg from '@/assets/peppers/rocotillo.jpg';
import ajiColoradoImg from '@/assets/peppers/aji-colorado.jpg';
import ajiVerdeImg from '@/assets/peppers/aji-verde.jpg';
...
export const pepperImageMap: Record<string, string> = {
  ...
  'aji-limon': ajiLimonImg,
  'ancho': anchoImg,
  'calabrian': calabrianImg,
  'datil': datilImg,
  'de-arbol': deArbolImg,
  'devils-breath': devilsBreathImg,
  'ghost': ghostImg,
  'gochugaru': gochugaruImg,
  'hatch-green-chili': hatchGreenChiliImg,
  ...
  'wiri-wiri': wiriWiriImg,
  'bell-pepper': bellPepperImg,
  'poblano': poblanoImg,
  'jalapeno': jalapenoImg,
  'serrano': serranoImg,
  'cayenne': cayenneImg,
  'hungarian-wax': hungarianWaxImg,
  'banana-pepper': bananaPepperImg,
  'shishito': shishitoImg,
  'padron': padronImg,
  'peppadew': peppadewImg,
  'espelette': espeletteImg,
  'urfa-biber': urfaBiberImg,
  'kashmiri-chili': kashmiriChiliImg,
  'guntur-sannam': gunturSannamImg,
  'byadgi': byadgiImg,
  'thai-birds-eye': thaiBirdsEyeImg,
  'peri-peri-african': periPeriAfricanImg,
  'tabasco': tabascoImg,
  'habanero': habaneroImg,
  'bhut-jolokia': bhutJolokiaImg,
  'carolina-reaper': carolinaReaperImg,
  'rocoto': rocotoImg,
  ...
  'aji-cerezo': ajiCerezoImg,
  'aji-dulce': ajiDulceImg,
  'charapita': charapitaImg,
  'biquinho': biquinhoImg,
  'bahamian-goat': bahamianGoatImg,
  '7-pot-douglah': sevenPotDouglahImg,
  '7-pot-primo': sevenPotPrimoImg,
  'manzano': manzanoImg,
  'guindilla': guindillaImg,
  'fresno': fresnoImg,
  'cherry-pepper': cherryPepperImg,
  'cubanelle': cubanelleImg,
  'anaheim': anaheimImg,
  'cascabel': cascabelImg,
  'arbol': arbolImg,
  'mulato': mulatoImg,
  'mirasol': mirasolImg,
  'tepin': tepinImg,
  'tien-tsin': tienTsinImg,
  'er-jing-tiao': erJingTiaoImg,
  'facing-heaven': facingHeavenImg,
  'korean-cheongyang': koreanCheongyangImg,
  'siling-labuyo': silingLabuyoImg,
  'birds-eye-malaysia': birdsEyeMalaysiaImg,
  'madame-jeanette': madameJeanetteImg,
  'adjuma': adjumaImg,
  'congo-pepper': congoPepperImg,
  'rocotillo': rocotilloImg,
  'aji-colorado': ajiColoradoImg,
...
export function getPepperImage(pepperId: string): string | undefined {
  return pepperImageMap[pepperId];
}
